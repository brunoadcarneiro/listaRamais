			...
			<div class="container pagina">
				<div class="row">
					<div class="col">
						...
						<h4>Cadastro de Ramais</h4>
						<hr />
						<?php if (isset($_GET['inclusao']) && $_GET['inclusao'] == 1) { ?>
							<div class="alert alert-success text-center">
								<h5>Ramal inserido com sucesso</h5>
							</div>
						<?php } ?>
						<form method="post" action="../controller/RamalController.php?acao=inserir">
							<div class="form-group">
								<label>Ramal:</label>
								<input type="text" class="form-control" name="numero" placeholder="Digite o numero do ramal...">
							</div>
